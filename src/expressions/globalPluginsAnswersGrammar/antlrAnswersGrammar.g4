...
question_integer: ctx_question=QUESTION  ctx_type=TYPE_INTEGER NEWLINE ctx_answer=NUMERIC_VALUE BEFORE_VALUE_TOKEN ctx_value=NUMERIC_VALUE ENDOFLINE NEWLINE;
