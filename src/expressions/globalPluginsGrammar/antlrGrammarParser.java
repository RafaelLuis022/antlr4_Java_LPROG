...
public class antlrGrammarParser extends Parser {
	...
	public static final int
		...
		TYPE_INTEGER=11, TYPE_SHORTTEXT=12, NUMERICALSCALEANSWER=13, DATEANSWER=14, 
		DECIMALANSWER=15, TIMEHOURANSWER=16, INTEGERANSWER=17, TRUEFALSEANSWER=18, 
		QUESTION=19, SINGLECHOISEANSWER=20, SHORTTEXTANSWER=21, EMPTY=22, MULTIPLECHOISEANSWER=23, 
		STRING=24, CHAR=25, WS=26;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "'n/a'", "'END'", null, "'(True/False)'", "'(HMHH:MM)'", "'(Date:dd/mm/yyyy)'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"TYPE_INTEGER", "TYPE_SHORTTEXT", "NUMERICALSCALEANSWER", "DATEANSWER", 
	...
	public final Question_multiplechoiceContext question_multiplechoice() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 9437186L) != 0)) ) {
